...
return [
    ...
    'course_block_missing_type_hint_comparison_row' => "Bloc :n : clé 'type' manquante - on dirait une row de comparison. Enveloppe ces objets dans { \"type\": \"comparison\", \"columns\": [...], \"rows\": [...] }.",
    'course_block_missing_type_hint_step_or_callout' => "Bloc :n : clé 'type' manquante - on dirait une step ou un callout. Ajoute \"type\": \"steps\" (avec \"steps\": [...]) ou \"type\": \"callout\".",
    'course_block_missing_type_hint_list_or_summary' => "Bloc :n : clé 'type' manquante - on dirait une liste ou un résumé. Ajoute \"type\": \"list\" ou \"type\": \"summary\".",
    'course_block_missing_type_hint_paragraph' => "Bloc :n : clé 'type' manquante - on dirait un paragraphe. Ajoute \"type\": \"paragraph\".",
