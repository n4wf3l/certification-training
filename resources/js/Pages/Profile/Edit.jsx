            ...
            <div className="mx-auto max-w-4xl space-y-6">
                <div>
                    <div className="mb-2 flex items-center gap-2 text-xs text-ink-500">
                        <Link href={route('home')} className="hover:text-brand-500">{t('profile.breadcrumb_home')}</Link>
                        <span>/</span>
                        <span className="text-ink-700 dark:text-ink-300">{t('profile.breadcrumb_profile')}</span>
                    </div>
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-sm text-ink-500">
                                {user?.email}
                                {user?.is_admin && (
                                    <span className="badge-brand ml-2 !py-0 text-[10px]">{t('profile.admin_badge')}</span>
                                )}
                            </p>
                        </div>
                    </div>
